    ...
    <div>
        ...
        <div className="mx-auto max-w-2xl py-32 sm:py-48 lg:py-56">
          <div className="text-center">
            ...
            <p className="mt-6 text-lg leading-8">
              English Together는 영어 학습을 새로운 차원으로 끌어올리고자 탄생했습니다.
              우리는 당신이 혼자가 아닌, 함께 학습할 수 있는 파트너를 찾도록 돕습니다.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="py-16 bg-gray-100">
        <div className="max-w-screen-xl mx-auto px-4">
          <h2 className="text-3xl font-bold text-center mb-12 text-black">우리의 사명</h2>
          <div className="text-center max-w-3xl mx-auto text-lg leading-8 text-black">
            <p>
              우리의 목표는 모든 학습자가 영어를 쉽고 재미있게 배울 수 있도록 돕는
              것입니다. 이를 위해, 우리는 학습자들을 연결하고, 그들이 함께 공부하며 서로를
              지원할 수 있는 플랫폼을 제공합니다.
            </p>
          </div>
        </div>
      ...
      <section className="py-16 bg-gray-100">
        <div className="max-w-screen-xl mx-auto px-4 text-center">
          <h2 className="text-3xl font-bold mb-8 text-black">우리와 함께하세요</h2>
          <p className="text-lg leading-8 text-black mb-8">
            English Together와 함께 영어 학습의 여정을 시작하세요. 혼자가 아닌, 같은
            목표를 가진 사람들과 함께 배우세요.
          </p>
          <Link
            href="/contact"
