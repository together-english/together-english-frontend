        ...
        <div className="mx-auto max-w-2xl py-32 sm:py-48 lg:py-56">
          <div className="text-center">
            ...
            <p className="mt-6 text-lg leading-8">
              저희 웹사이트의 사용 조건 및 오픈 소스 라이선스 정보를 확인하세요.
              이 정보를 통해 사용 약관을 명확히 이해할 수 있습니다.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="py-16 bg-gray-100">
        <div className="max-w-screen-md mx-auto px-4">
          ...
          <div className="space-y-6 text-black leading-8">
            <p>
              저희 웹사이트에서 제공하는 모든 콘텐츠(이미지, 텍스트, 코드 등)는
              저작권법에 의해 보호됩니다. 이 콘텐츠를 무단으로 사용, 복제,
              배포하는 것은 금지되어 있습니다.
            </p>
            <p>
              저희는 웹사이트 개발에 오픈 소스 소프트웨어를 사용하고 있으며, 각
              소프트웨어의 라이선스 조건에 따라 사용하고 있습니다. 아래는 주요
              오픈 소스 라이선스 정보입니다:
            </p>
            ...
            <p>
              각 오픈 소스 프로젝트의 라이선스 전문은 해당 프로젝트의 공식
              저장소에서 확인할 수 있습니다.
            </p>
            <p>
              이 웹사이트를 사용함으로써 사용자는 본 사용 약관 및 라이선스
              정보에 동의하게 됩니다. 문의 사항이 있으시면{" "}
