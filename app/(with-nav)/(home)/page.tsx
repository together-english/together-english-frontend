        ...
        <div className="mx-auto max-w-2xl py-32 sm:py-48 lg:py-56">
          <div className="text-center">
            ...
            <p className="mt-6 text-lg leading-8">
              영어 학습 동료와 함께 지역 카페에서 공부하며 영어 실력을 키우세요.
              비슷한 수준의 학습자들과 만나 재미있고 효과적인 학습을
              경험해보세요!
            </p>
            <div className="mt-10 flex justify-center gap-x-6">
              <Link
                href="/register"
                className="rounded-md bg-yellow-500 px-3.5 py-2.5 text-sm font-semibold text-black shadow-sm hover:bg-yellow-600"
              >
                시작하기
              </Link>
              <Link
        ...
        <div className="max-w-screen-xl mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="bg-gray-100 p-6 rounded-lg shadow-lg">
              ...
              <p>
                영어 능력 수준에 맞는 다른 학습자들과 매칭되어 효과적이고
                흥미로운 학습을 경험하세요.
              </p>
            </div>
            {/* Feature 3 */}
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div className="bg-gray-100 p-6 rounded-lg shadow-lg">
              <p className="text-black mb-4">
                "English Together는 제 영어 학습에 큰 도움이 되었습니다. 지역
                카페에서 새로운 친구들과 공부하는 것은 정말 재미있어요!"
              </p>
            ...
            <div className="bg-gray-100 p-6 rounded-lg shadow-lg">
              <p className="text-black mb-4">
                "다양한 수준의 학습자와 연결되어 영어 실력을 빠르게 향상시킬 수
                있었어요. 추천합니다!"
              </p>
            ...
            <div className="bg-gray-100 p-6 rounded-lg shadow-lg">
              <p className="text-black mb-4">
                "사용하기 쉬운 플랫폼으로, 영어 학습에 필요한 모든 것이 다
                있어요. 특히 카페에서 만나는 것이 좋습니다."
              </p>
